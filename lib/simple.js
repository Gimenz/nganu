...
exports.generateUrlInfo = async (jid, text, title = 'enak mas', description = 'nganu mas', jpegThumbnail = './src/logo.jpg', quoted = {}) => {
...
exports.downloadMediaMessage = async (message) => {
    ...
    const stream = await downloadContentFromMessage(message, mediaType[message.mtype])
...
exports.Serialize = (sock, m) => {
    ...
    * Copy this message
    */
    m.copy = () => exports.Serialize(client, M.fromObject(M.toObject(m)))
