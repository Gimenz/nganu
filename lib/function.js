const { S_WHATSAPP_NET, getHttpStream, toBuffer } = require('@adiwajshing/baileys-md')
const { fromBuffer } = require('file-type')
const fs = require('fs')
const mime = require('mime-types')
const { isUrl } = require('../utils')
const { toGif } = require('./converter')
 ...
 * @param {Object} optionsOverride You can use this to override the [axios request config](https://github.com/axios/axios#request-config)
